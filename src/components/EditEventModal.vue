<template>
    <div class="backdrop" @click.self="close" @scroll.self.prevent @wheel.self.prevent  >
                ...
                <vee-form @submit="update" :validation-schema="schema">
                    ...
                    <div class="file-input">
                        <div class="d-flex">
                            ...
                            <p class="ms-auto clear mb-0 pointer" @click="displayUrl = null" v-if="displayUrl !== null">revert<i class="fa-solid fa-backward"></i></p>
                            <p class="ms-auto clear mb-0" @click="displayUrl = 'none'">remove<i class="fa-solid fa-eraser"></i></p>
                        </div>
...
export default {
    ...
    async created() {
        ...
        this.tekEvent = event.data.event;
    },
    data() {
        return {
            color: 'FFF',
    ...
    methods: {
        ...
        async update(values) {
            ...
            if (this.displayUrl && this.displayUrl !== 'none') {
                formData.append('image', values.profileImage);
            } else if (this.displayUrl === 'none') {
            ...
            let obj = {
                ...
                'attendeesCount': this.tekEvent.attendeesCount,
            };

            if (this.displayUrl === null) {
                obj. displayUrl = this.tekEvent.displayUrl;
            } else if (this.displayUrl === 'none') {
                obj.displayUrl = 'https://ticketlinkz.com/wp-content/uploads/2014/12/EVENT-PLACEHOLDER.jpg'
            } else {
                obj.displayUrl = this.displayUrl;
            }
